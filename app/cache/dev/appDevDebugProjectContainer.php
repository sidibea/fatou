...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PUGXAutocompleterBundle', ($this->targetDirs[2].'/Resources/PUGXAutocompleterBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PUGXAutocompleterBundle', ($this->targetDirs[3].'/vendor/pugx/autocompleter-bundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/NB/MainBundle/Entity'), 1 => ($this->targetDirs[3].'/src/NB/UsersBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'NB\\MainBundle\\Entity');
        $c->addDriver($b, 'NB\\UsersBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('NBMainBundle' => 'NB\\MainBundle\\Entity', 'NBUsersBundle' => 'NB\\UsersBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_eebf5c22bb08bd27bde353cb76561a95ede0da2fccc7115161f5da7352e9ebd4');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('NB\\UsersBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('NB\\UsersBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('NB\\UsersBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('NB\\UsersBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('doctrine')->getManager(NULL), 'NB\\UsersBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('NB\\UsersBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('39c975ea222e7a36442d79403e28617b5f3e8d92');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username'), $a, 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, '39c975ea222e7a36442d79403e28617b5f3e8d92', 'main'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5896526881a9a4.48135274')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_CUSTOMER' => array(0 => 'ROLE_CUSTOMER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'admin_link' => 'http://localhost/nextBusAdmin/web/',
            'mailer_user' => NULL,
            'vitepay_api_key' => 'Nc6nS3I1pbYojQ',
            'vitepay_api_secret' => '18d8250938e773b44e8e014d99baa420',
            'mailer_password' => NULL,
            'secret' => '39c975ea222e7a36442d79403e28617b5f3e8d92',
            'locale' => 'en',
            ...
            'kernel.secret' => '39c975ea222e7a36442d79403e28617b5f3e8d92',
            ...
            'assetic.bundles' => array(
                ...
                7 => 'AsseticBundle',
                8 => 'IvoryCKEditorBundle',
                9 => 'PUGXAutocompleterBundle',
                10 => 'FOSUserBundle',
                11 => 'NBMainBundle',
                12 => 'NBUsersBundle',
                13 => 'DebugBundle',
            ...
            'fos_user.model.user.class' => 'NB\\UsersBundle\\Entity\\User',
